...
source code is generated by kubebuilder with (details , please refer to "make build--apr-02.rtf")

kubebuilder init   --plugins=go/v4   --repo kubeai
...
This is a kick start point of kubeAI,
